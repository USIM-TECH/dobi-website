    ...
    <footer className="bg-[#152956] text-[#b9c6d6] pt-20 pb-8 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.2fr] gap-12 relative z-10">
        ...
        <div className="space-y-5">
          <h3 className="text-lg font-bold text-white uppercase tracking-wider">Services</h3>
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white uppercase tracking-wider">Contact & Socials</h3>
            <ul className="space-y-3 text-lg font-semibold">
          ...
          <div className="space-y-3">
            <h4 className="text-base font-bold uppercase tracking-wider text-[#1d6ff0]">Follow Our Community</h4>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-base text-slate-400">
