      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            {/* Category Tag */}
            <span className="text-brand-600 font-bold text-base sm:text-lg tracking-widest uppercase mb-3 block">
              ABOUT DOBI-AKASIA
            </span>
            ...
            {/* Paragraphs */}
            <div className="space-y-4 text-slate-500 text-lg sm:text-lg leading-relaxed mb-8">
              <p>
              ...
              {features.map((item, idx) => {
                ...
                return (
                  <div key={idx} className="flex items-start gap-4 p-4 rounded-2xl border border-slate-100 bg-brand-50/20 hover:bg-white hover:border-brand-200 hover:shadow-lg hover:shadow-brand-950/5 transition-all duration-300">
                    ...
                    <div>
                      <h4 className="font-extrabold text-brand-950 text-lg sm:text-lg leading-snug">
                        {item.title}
                      </h4>
                      <p className="text-base text-slate-500 leading-normal mt-1">
                        {item.description}
                      </p>
                    </div>
                  </div>
