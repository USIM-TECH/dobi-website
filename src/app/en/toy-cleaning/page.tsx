...
export default function ToyCleaningPage() {
  const title = "Top-Quality Toy Cleaning";
  const intro = "Sanitize and clean your children's favourite plush toys. We use non-toxic, child-safe detergents and low-temperature drying to kill germs without damaging stuffed materials.";
  const startPrice = "Starts From RM15";
  ...
  {
    "item": "3 Soft Toys Combo",
    "price": "RM39"
  },
  {
    "item": "5 Soft Toys Combo",
    "price": "RM59"
  }
];
  const faqs: { question: string; answer: string }[] = [
  {
    "question": "What toys qualify for combo pricing?",
    "answer": "Combo pricing applies to soft plush toys up to 50cm height."
  },
  {
    "question": "What if my soft toy is larger than 50cm?",
    "answer": "Larger soft toys will be quoted separately based on dimensions."
  }
];
  const steps: { title: string; desc: string }[] = [
  {
    "title": "Stitch Inspection",
    "desc": "Checking plush seams, plastic eyes, and sound modules before washing."
  },
  {
    "title": "Hypoallergenic Wash",
    "desc": "Washed with non-toxic, child-safe, fragrance-free detergents."
  },
  {
    "title": "Low-Temp Drying",
    "desc": "Sanitizing low-heat dry to ensure inner stuffing dries completely."
  },
  {
    "title": "Brushing & Shaping",
    "desc": "Manual fur brushing to restore soft plush fluffiness."
  },
  {
    "title": "Safety Packaging",
    "desc": "Sealed in clean hygienic bags to protect toys from dust."
  }
];
