...
export default function DryCleaningPage() {
  ...
  const faqs: { question: string; answer: string }[] = [
  {
    ...
    "answer": "Dry cleaning is a professional cleaning process that uses a specialized cleaning solvent instead of water to clean delicate fabrics without causing shrinkage or discoloration."
  },
  {
    "question": "Can dry cleaning remove all stains?",
    "answer": "We use professional stain treatment techniques and always do our best to remove stains. However, the outcome depends on fabric type and stain age."
  },
  {
    "question": "Do you offer pickup & delivery?",
    "answer": "Yes. Pickup and delivery are available in selected Klang Valley areas. Contact us via WhatsApp to arrange."
  },
  {
    "question": "How long does dry cleaning take?",
    "answer": "Most dry cleaning orders are ready within 3 working days."
  }
];
  const steps: { title: string; desc: string }[] = [
  {
    "title": "Garment Inspection",
    "desc": "Thorough fabric diagnosis to identify material sensitivity, seam integrity, and care label instructions."
  },
  {
    "title": "Pre-stain Treatment",
    "desc": "Targeted application of gentle eco-solvent spot removers to stubborn collar or cuff marks."
  },
  {
    "title": "Solvent Dry Cleaning",
    "desc": "Processed in closed-loop, temperature-controlled dry cleaning units with eco-friendly solvents."
  },
  {
    "title": "Hand Finishing & Pressing",
    "desc": "Precise steam ironing and hand pressing by certified technicians to restore crisp garment shape."
  },
  {
    "title": "Final Quality Inspection",
    "desc": "Multi-point inspection audit prior to placing garments in breathable dust-proof packaging."
  }
];
