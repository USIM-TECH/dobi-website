...
export default function CurtainCleaningPage() {
  const title = "Curtain Cleaning Service";
  const intro = "Refresh your home atmosphere with our professional curtain cleaning. We offer complete support, including free removal and installation assistance, ensuring a stress-free process.";
  const startPrice = "Starts From RM25";
  ...
  {
    "question": "Do you offer removal & installation assistance?",
    "answer": "Yes! Our team can assist with taking down and re-hanging your curtains upon request."
  },
  {
  ...
  {
    "title": "Removal & Marking",
    "desc": "Curtain hooks and drapes are tagged and measured to track original dimensions."
  },
  {
    "title": "Dust Extraction Wash",
    "desc": "Deep dust vibration extraction followed by fabric-safe immersion washing."
  },
  {
    "title": "Shrinkage-Safe Drying",
    "desc": "Air-flow drying room treatment ensuring ZERO fabric shrinkage."
  },
  {
    "title": "Steam Pleating",
    "desc": "Industrial vertical steam pressing to form crisp, uniform curtain pleats."
  },
  {
    "title": "Re-hanging & Delivery",
    "desc": "Delivered on protective drapes or re-installed directly at your home."
  }
];
