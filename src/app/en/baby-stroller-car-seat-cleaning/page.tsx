...
export default function BabyStrollerCarSeatCleaningPage() {
  const title = "Baby Stroller & Car Seat Cleaning";
  const intro = "Thorough hygiene treatment for baby gear. We remove food spills, sweat stains, and bacteria from strollers, car seats, cots, and carriers using baby-friendly sanitizers.";
  ...
  {
    "question": "How do the RM149 and RM199 Baby Gear Cleaning Combos work?",
    "answer": "Mix and match any 2 eligible items for RM149, or any 3 items for RM199 (includes strollers, car seats, cots, carriers, and rockers)."
  },
  {
    "question": "What is the processing time?",
    "answer": "Our processing time is 7 working days to ensure thorough deep drying."
  }
];
  const steps: { title: string; desc: string }[] = [
  {
    "title": "Frame Vacuuming",
    "desc": "Disassembling removable fabric pads and vacuuming frame crevices."
  },
  {
    "title": "Extraction Wash",
    "desc": "Deep steam extraction of food spills, milk stains, and sweat from fabric covers."
  },
  {
    "title": "Non-Toxic Sanitize",
    "desc": "Treating metal and plastic frames with baby-safe disinfectant."
  },
  {
    "title": "Meticulous Reassembly",
    "desc": "Thorough drying followed by safety check during harness re-assembly."
  },
  {
    "title": "Dust Wrapper",
    "desc": "Wrapped in clean protective bags for hygienic pickup."
  }
];
      ...
      <section className="bg-gradient-to-r from-blue-50 to-white pt-36 pb-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div className="hidden lg:block relative aspect-[4/3] rounded-3xl overflow-hidden shadow-xl bg-gray-50 border border-gray-100">
            <img
              src="https://images.unsplash.com/photo-1591154669695-5f2a8d20c089?auto=format&fit=crop&w=1000&q=80"
              alt={title}
