...
export default function ShoeCleaningPage() {
  const title = "Expert Shoe Cleaning";
  const intro = "Revive your sneakers, suede, and leather shoes. Our technicians manually clean out dirt, wash midsoles, scrub undersoles, and treat leather surfaces to restore original looks.";
  const startPrice = "Starts From RM35";
  ...
  {
    "item": "Shoe (Leather & High Top)",
    "price": "RM80"
  }
];
  const faqs: { question: string; answer: string }[] = [
  {
    "question": "Can I use the RM59 and RM99 combos for all types of shoes?",
    "answer": "The RM59 and RM99 combo offers cover standard shoes. High-top sneakers and leather shoes are subject to standard rates."
  },
  {
    "question": "Do you clean all types of shoes?",
    "answer": "Yes, including sneakers, suede, canvas, and fine leather shoes."
  },
  {
    "question": "What is the turnaround time?",
    "answer": "Typical processing time is 5 to 6 working days."
  }
];
  const steps: { title: string; desc: string }[] = [
  {
    "title": "Sole Brushing",
    "desc": "Dry brushing to clear mud and stones from outsoles and tread grooves."
  },
  {
    "title": "Uppers Manual Clean",
    "desc": "Hand scrubbing with specialized sneaker or suede cleaners."
  },
  {
    "title": "Midsole Washing",
    "desc": "Stain treatment and whitening applied to yellowed midsoles."
  },
  {
    "title": "Odour Sanitization",
    "desc": "UV sanitization and deodorizing spray applied inside shoe insoles."
  },
  {
    "title": "Natural Air Drying",
    "desc": "Temperature-controlled shade drying to prevent sole ungluing or leather stiffening."
  }
];
