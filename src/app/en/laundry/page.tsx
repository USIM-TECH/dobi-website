...
export default function LaundryPage() {
  ...
  const faqs: { question: string; answer: string }[] = [
  {
    ...
    "answer": "Our standard wash & fold service starts with a minimum order of 3kg per batch."
  },
  {
    "question": "Do you wash items separately from other customers?",
    "answer": "Yes, absolutely. Every customer order is washed separately in dedicated commercial drums for complete hygiene."
  },
  {
    "question": "What detergents do you use?",
    "answer": "We use SIRIM-certified eco-friendly biodegradable detergents that are gentle on fabrics and skin."
  }
];
  const steps: { title: string; desc: string }[] = [
  {
    "title": "Sorting & Tagging",
    "desc": "Items are sorted by fabric color, weight, and washing temp guidelines, then assigned unique tracking barcodes."
  },
  {
    "title": "Commercial Washing",
    "desc": "Washed using high-efficiency commercial extractors and SIRIM certified bio-degradable detergents."
  },
  {
    "title": "Tumble Drying",
    "desc": "Gently dried at controlled temperatures to maintain fabric softness and prevent shrinkage."
  },
  {
    "title": "Neat Folding & Pressing",
    "desc": "Expert hand folding or pressing on hangers based on customer delivery preferences."
  },
  {
    "title": "Customer Handover",
    "desc": "Packaged in clean protective bags, ready for pickup at your chosen outlet."
  }
];
