...
export default function BeddingCleaningPage() {
  const title = "Bedding Cleaning Service";
  const intro = "Deep sanitization and washing for your comforters, blankets, and pillows. We eliminate dust mites, allergens, and perspiration marks to give you a refreshing, hygienic sleep.";
  const startPrice = "Starts From RM30";
  ...
  {
    "question": "How long does bedding cleaning take?",
    "answer": "Standard turnaround time is 3 to 4 working days to ensure thorough allergen drying."
  },
  {
  ...
  {
    "title": "Size & Weight Sorting",
    "desc": "Bedding items are weighed and inspected for seam tear or feather leakage."
  },
  {
    "title": "Allergen Sanitizing Wash",
    "desc": "High-capacity drum wash treated with anti-bacterial agents to eradicate dust mites."
  },
  {
    "title": "Thorough Fluff Drying",
    "desc": "Extended low-heat tumble drying with fluffing balls to restore comforter volume."
  },
  {
    "title": "Fresh Scent Treatment",
    "desc": "Infused with subtle hypoallergenic fragrances for a refreshing sleep atmosphere."
  },
  {
    "title": "Dust-Proof Wrapping",
    "desc": "Vacuum sealed or packed in heavy-duty bedding storage bags."
  }
];
      ...
      <section className="bg-gradient-to-r from-blue-50 to-white pt-36 pb-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div className="hidden lg:block relative aspect-[4/3] rounded-3xl overflow-hidden shadow-xl bg-gray-50 border border-gray-100">
            <img
              src="https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?auto=format&fit=crop&w=1000&q=80"
              alt={title}
