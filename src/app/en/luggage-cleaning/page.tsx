...
export default function LuggageCleaningPage() {
  const title = "Luggage Cleaning Service";
  const intro = "Refresh your travel suitcases before or after a long journey. We vacuum interior compartments, scrub hard shells, clean wheels, and sanitize handles to keep bags fresh.";
  const startPrice = "Starts From RM60";
  ...
  {
    "item": "2 Luggages Combo",
    "price": "RM119"
  },
  {
    "item": "3 Luggages Combo",
    "price": "RM159"
  }
];
  const faqs: { question: string; answer: string }[] = [
  {
    "question": "What luggage sizes qualify?",
    "answer": "Combos apply to suitcases up to 80cm height measured from wheels to top."
  },
  {
    "question": "What is included in luggage cleaning?",
    "answer": "Exterior shell scrub, interior vacuum, wheel area degreasing, and odour treatment."
  }
];
  const steps: { title: string; desc: string }[] = [
  {
    "title": "Interior Vacuuming",
    "desc": "Clearing sand, dust, and debris from luggage pockets and zippers."
  },
  {
    "title": "Hard Shell Scrub",
    "desc": "Scrubbing exterior hard shells or fabric surfaces with stain removers."
  },
  {
    "title": "Wheel Degreasing",
    "desc": "Cleaning wheel bearings, handles, and telescopic extension rods."
  },
  {
    "title": "Zipper & Lock Check",
    "desc": "Lubricating zippers and checking TSA lock functionality."
  },
  {
    "title": "Deodorizing",
    "desc": "Interior antibacterial scenting to eliminate stale travel odours."
  }
];
      ...
      <section className="bg-gradient-to-r from-blue-50 to-white pt-36 pb-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div className="hidden lg:block relative aspect-[4/3] rounded-3xl overflow-hidden shadow-xl bg-gray-50 border border-gray-100">
            <img
              src="https://images.unsplash.com/photo-1565026057447-b8899f290906?auto=format&fit=crop&w=1000&q=80"
              alt={title}
