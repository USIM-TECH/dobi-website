...
export default function StainRemovalPage() {
  const title = "Expert Stain Removal";
  const intro = "Got a stubborn stain on your favourite garment? Dobi Akasia employs localized chemical applications and premium cleaning technology to breakdown blemishes safely.";
  const startPrice = "Starts From RM12";
  
  const prices: { item: string; price: string }[] = [
  {
    "item": "Stain Treatment",
    "price": "Starts From RM12"
  }
];
  const faqs: { question: string; answer: string }[] = [
  {
    "question": "Do you guarantee complete removal of all stains?",
    "answer": "While we strive to eliminate all stains, factors like stain age and fabric delicacy affect final clearance."
  },
  {
    "question": "What types of stains can you treat?",
    "answer": "Coffee, wine, grease, oil, makeup, ink, perspiration, and food dye marks."
  }
];
  const steps: { title: string; desc: string }[] = [
  {
    "title": "Stain Evaluation",
    "desc": "Determining stain origin (protein, tannin, grease, or chemical) and fabric type."
  },
  {
    "title": "Targeted Spotting",
    "desc": "Applying specific chemical spotters to loosen stain bonds."
  },
  {
    "title": "Vacuum Suction Extraction",
    "desc": "Flushing the area with steam and vacuuming out dissolved blemish particles."
  },
  {
    "title": "Gentle Wash Integration",
    "desc": "Submitting garment to standard washing cycle to eliminate residual chemicals."
  },
  {
    "title": "Final Inspection",
    "desc": "Examining thread under daylight lamps to confirm 100% stain clearance."
  }
];
