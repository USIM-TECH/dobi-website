...
export default function WeddingGownCleaningPage() {
  const title = "Wedding Gown Cleaning";
  const intro = "Meticulous care for your wedding gown. Our experts treat lace, satin, and embroidery individually to preserve special bridal memories without discoloration.";
  const startPrice = "Starts From RM100";
  
  const prices: { item: string; price: string }[] = [
  {
    "item": "Wedding Gown Care",
    "price": "Starts From RM100"
  }
];
  const faqs: { question: string; answer: string }[] = [
  {
    "question": "Do you clean all types of wedding gowns?",
    "answer": "Yes, we handle a wide range of gown styles, fabrics, and trains with individual hand care."
  },
  {
    "question": "What is the processing time?",
    "answer": "Standard turnaround is 5 working days."
  }
];
  const steps: { title: string; desc: string }[] = [
  {
    "title": "Fabric Mapping",
    "desc": "Identifying lace, tulle, sequins, and train soil marks under special lighting."
  },
  {
    "title": "Hand Stain Pre-treatment",
    "desc": "Dabbing delicate stain removers on hemline dirt and makeup spots."
  },
  {
    "title": "Gentle Eco Wash",
    "desc": "Immersion wash in pure eco solvents that won't loosen delicate beadwork."
  },
  {
    "title": "Gentle Hand Pressing",
    "desc": "Low-temperature steam pressing of layers, pleats, and train."
  },
  {
    "title": "Acid-Free Storage",
    "desc": "Encased in breathable bridal garment bags or preservation boxes."
  }
];
      ...
      <section className="bg-gradient-to-r from-blue-50 to-white pt-36 pb-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div className="hidden lg:block relative aspect-[4/3] rounded-3xl overflow-hidden shadow-xl bg-gray-50 border border-gray-100">
            <img
              src="https://images.unsplash.com/photo-1594552072238-b8a33785b261?auto=format&fit=crop&w=1000&q=80"
              alt={title}
